                ...
                <table class="contentMainTable" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td style="padding-left:10px;padding-top:10px;vertical-align:top;">
                            <?php
                                boxStart('Nach Benutzernamen suchen', 'Sie k&ouml;nnen eine Zeitspanne angeben, die sich die Benutzer schon mindestens im Papierkorb befinden sollen.');
                        ...
                        <td style="padding-right:10px;padding-top:10px;vertical-align:top;">
                            <?php
                                ...
                                if ($this->timespan != null) {
                                    ...
                                    if(count($this->results) != 0) echo '<tr><td colspan=3 style="text-align:right"><button class=basicButton name=empty value=true onclick="javascript:document.emptyForm.submit();">endg&uuml;ltig l&ouml;schen</button></td></tr>';
                                    echo '</table>';
                                    echo '<input type=hidden name=cmd value=emptyTrash>';
                                    echo '</form>';
                                } else {
